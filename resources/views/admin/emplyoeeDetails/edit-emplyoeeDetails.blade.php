...
@section('content')
    <div class="row">
        ...
        <div class="col-xl-6 mx-auto">
            <form action="{{route('update-employeeDetails')}}" method="post" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="card-body">
                        <div class="border p-4 rounded">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="emplyoee_address" class="form-control" id="inputPhoneNo2" placeholder="Full Name">{{$emplyoeeDetails->emplyoee_address}}</textarea>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <img src="{{asset($emplyoeeDetails->employee_image)}}" style="width:50px;height:50px;"alt="">
                                </div>
                            </div>
                            <div class="row">
